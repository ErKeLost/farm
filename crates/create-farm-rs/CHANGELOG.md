...
## [0.1.3](https://github.com/ErKeLost/farm/compare/create-farm-v0.1.2...create-farm-v0.1.3) - 2024-10-03

### Added

- *(cli)* support re-prompt project name ([#1732](https://github.com/ErKeLost/farm/pull/1732))

### Other

- *(create-farm)* update README for vanilla template ([#1724](https://github.com/ErKeLost/farm/pull/1724))
- *(create-farm)* rewrite `create-farm` ([#1700](https://github.com/ErKeLost/farm/pull/1700))
