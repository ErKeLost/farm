...
## [2.0.1](https://github.com/ErKeLost/farm/compare/farmfe_plugin_runtime-v2.0.0...farmfe_plugin_runtime-v2.0.1) - 2025-09-01

### Fixed

- ci issues ([#2230](https://github.com/ErKeLost/farm/pull/2230))
# Changelog
All notable changes to this project will be documented in this file.
