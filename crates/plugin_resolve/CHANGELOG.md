...
## [0.0.16](https://github.com/ErKeLost/farm/compare/farmfe_plugin_resolve-v0.0.15...farmfe_plugin_resolve-v0.0.16) - 2025-08-02

### Added

- browser mode, resolve mainFiled without import kind ([#2197](https://github.com/ErKeLost/farm/pull/2197))
- resolver by resolve kind ([#2154](https://github.com/ErKeLost/farm/pull/2154))

### Fixed

- resolve extension compatible with . or direct file suffix ([#2192](https://github.com/ErKeLost/farm/pull/2192))
- *(plugin_resolve)* duplicated querystring on external ([#2057](https://github.com/ErKeLost/farm/pull/2057))
# Changelog
All notable changes to this project will be documented in this file.
