...
## [0.0.12](https://github.com/ErKeLost/farm/compare/farmfe_compiler-v0.0.11...farmfe_compiler-v0.0.12) - 2024-10-31

### Fixed

- plugin circle call & dynamic import ([#1901](https://github.com/ErKeLost/farm/pull/1901))
- wrong esm introp helper order when using top level await ([#1897](https://github.com/ErKeLost/farm/pull/1897))
- css resolving issue ([#1834](https://github.com/ErKeLost/farm/pull/1834))
- namespace import MemberProp name failed ([#1826](https://github.com/ErKeLost/farm/pull/1826))
- lazy compilation cache && postcss tailwind does not work on windows ([#1808](https://github.com/ErKeLost/farm/pull/1808))
- arcgis lazy compile fail ([#1750](https://github.com/ErKeLost/farm/pull/1750))
- html runtime inject failed when build multiple page ([#1760](https://github.com/ErKeLost/farm/pull/1760))
...
- *(refactor)* refactor stats and visualizer ([#1739](https://github.com/ErKeLost/farm/pull/1739))
