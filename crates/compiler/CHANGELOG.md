...
## [0.0.17](https://github.com/ErKeLost/farm/compare/farmfe_compiler-v0.0.16...farmfe_compiler-v0.0.17) - 2025-08-02

### Added

- *(hmr)* support calling compiler.update to compile a full new module ([#2119](https://github.com/ErKeLost/farm/pull/2119))

### Fixed

- tree shake issue when handling cross module top level variables … ([#2166](https://github.com/ErKeLost/farm/pull/2166))
- cjs node export order ([#2149](https://github.com/ErKeLost/farm/pull/2149))
- assign reference treeshake ([#2141](https://github.com/ErKeLost/farm/pull/2141))
- *(hmr)* panic when call compiler.update for a full new module multi… ([#2120](https://github.com/ErKeLost/farm/pull/2120))
- #2103 and resource pot id hash conflicts ([#2107](https://github.com/ErKeLost/farm/pull/2107))
- persistent cache panic when using addFileWatchFile with query #2067 ([#2068](https://github.com/ErKeLost/farm/pull/2068))
# Changelog
All notable changes to this project will be documented in this file.
