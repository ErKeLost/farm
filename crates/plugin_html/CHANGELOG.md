...
## [0.0.16](https://github.com/ErKeLost/farm/compare/farmfe_plugin_html-v0.0.15...farmfe_plugin_html-v0.0.16) - 2025-08-02

### Fixed

- incorrect publicPath when isolating farm runtime ([#2193](https://github.com/ErKeLost/farm/pull/2193))
# Changelog
All notable changes to this project will be documented in this file.
