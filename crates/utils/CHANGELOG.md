...
## [0.1.7](https://github.com/ErKeLost/farm/compare/farmfe_utils-v0.1.6...farmfe_utils-v0.1.7) - 2025-08-02

### Fixed

- handle Windows long path issue in base64_decode function ([#2182](https://github.com/ErKeLost/farm/pull/2182))
# Changelog
All notable changes to this project will be documented in this file.
