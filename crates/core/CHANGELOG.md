...
## [0.7.4](https://github.com/ErKeLost/farm/compare/farmfe_core-v0.7.3...farmfe_core-v0.7.4) - 2025-08-02

### Added

- resolver by resolve kind ([#2154](https://github.com/ErKeLost/farm/pull/2154))
...
- support output.asciiOnly ([#2200](https://github.com/ErKeLost/farm/pull/2200))
