...
## [0.4.3](https://github.com/ErKeLost/farm/compare/farmfe_core-v0.4.2...farmfe_core-v0.4.3) - 2024-03-30

### Fixed
- less/sass url rebase and url publicPath ([#1071](https://github.com/ErKeLost/farm/pull/1071))

### Other
- *(splitQuery)* change split to splitOnce ([#1068](https://github.com/ErKeLost/farm/pull/1068))
