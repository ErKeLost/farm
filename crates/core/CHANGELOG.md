...
## [0.7.0](https://github.com/ErKeLost/farm/compare/farmfe_core-v0.6.4...farmfe_core-v0.7.0) - 2024-10-31

### Added

- add assets mode for asset path generate ([#1852](https://github.com/ErKeLost/farm/pull/1852))
- *(css)* support css module name coversion ([#1784](https://github.com/ErKeLost/farm/pull/1784))
- support resolve dedupe ([#1762](https://github.com/ErKeLost/farm/pull/1762))
...
- revert change of replacing invalid css ([#1831](https://github.com/ErKeLost/farm/pull/1831))
